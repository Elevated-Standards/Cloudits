...
environments = {
    'commercial': {
        ...
        'output_files': {
            ...
            'repository_policies': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_repository_policies.json",
            'ecr_tags': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_tags.json"
        }
    },
    'federal': {
        'region': 'us-west-2',
