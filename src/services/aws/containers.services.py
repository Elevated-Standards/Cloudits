...
environments = {
    'commercial': {
        ...
        'output_files': {
            # ECS Files
            'clusters': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecs_clusters.json",
            'services': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecs_services.json",
            'tasks': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecs_tasks.json",
            'task_definitions': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecs_task_definitions.json",
            'ecs_tags': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecs_tags.json",
            # ECR Public Files
            'public_repositories': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_public_repositories.json",
            'public_images': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_public_images.json",
            'public_repository_policies': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_public_repository_policies.json",
            'public_ecr_tags': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_public_tags.json",
            # ECR Private Files
            'private_repositories': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_private_repositories.json",
            'private_images': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_private_images.json",
            'private_repository_policies': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_private_repository_policies.json",
            'private_ecr_tags': f"{BASE_DIR}/commercial/systems//aws/{YEAR}/{MONTH}/{MONTH}-{DAY}-ecr_private_tags.json"
        }
    },
    'federal': {
        'region': 'us-west-2',
