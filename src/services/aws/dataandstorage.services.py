...
environments = {
    'commercial': {
        'region': 'us-east-1',
        'output_files': {
            'db_instances': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_instances.json',
            'db_snapshots': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_snapshots.json',
            'db_clusters': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_clusters.json',
            'db_security_groups': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_security_groups.json',
            'db_subnet_groups': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_subnet_groups.json',
            'db_log_files': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-db_log_files.json',
            'certificates': f'{BASE_DIR}/systems/aws/{YEAR}/{MONTH}-{DAY}-certificates.json',
